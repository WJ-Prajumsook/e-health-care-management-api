...
export const Medication = () => {
  const dataManager: DataManager = new DataManager({
    ...
    url: "http://192.168.64.2:31041/ehealthcare/v1/medications",
    //url: "http://localhost:8080/ehealthcare/v1/medications",
  });

  return(
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
      <Header category="Medications" title="Medications" />
      <GridComponent
      ...
      >
        <ColumnsDirective>
          ...
          <ColumnDirective field='medication' headerText='Medication' width='150' textAlign='Center' />
          <ColumnDirective field='status' headerText='Status' width='100' textAlign='Center' />
          <ColumnDirective field='intent' headerText='Intent' width='100' textAlign='Center' />
          <ColumnDirective field='priority' headerText='Priority' width='100' textAlign='Center' />
          <ColumnDirective field='value' headerText='Value' width='100' textAlign='Center' />
